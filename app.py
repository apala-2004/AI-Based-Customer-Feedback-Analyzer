...
def generate_reply(sentiment, category, emotion):
    """
    Generate an automatic customer reply
    based on sentiment, category, and emotion.
    """

    # Positive replies
    if sentiment == "Positive":
        if category == "Delivery":
            return "Thank you for your positive feedback. We’re glad the delivery experience met your expectations."

        elif category == "Product":
            return "We appreciate your valuable feedback and are happy that you liked our product."

        elif category == "Service":
            return "Thank you for recognizing our service. Your support motivates our team to do even better."

        return "Thank you for your positive feedback. We truly appreciate your support."

    # Negative replies
    elif sentiment == "Negative":

        if emotion == "Angry":
            return "We sincerely apologize for your unpleasant experience. Your concern is important to us, and we will work to resolve the issue immediately."

        elif category == "Delivery":
            return "We regret the inconvenience caused during delivery. We will work on improving our delivery process."

        elif category == "Product":
            return "We’re sorry that the product did not meet your expectations. Your feedback helps us improve our quality."

        elif category == "Service":
            return "We apologize for the inconvenience caused by our service. We will address the issue with our support team."

        return "We appreciate your feedback and sincerely apologize for your experience."

    # Neutral replies
    return "Thank you for sharing your feedback with us. Your opinion helps us improve our services."
...
def index():
    ...
    if request.method == "POST":
        ...
        if feedback_text:
            ...
            reply = generate_reply(label, category, emotion)
